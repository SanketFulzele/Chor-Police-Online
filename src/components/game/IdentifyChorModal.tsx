        ...
        <div role="dialog" aria-modal="true" className="fixed inset-0 z-[100] overflow-y-auto">
          ...
          <div className="flex min-h-full items-center justify-center p-4">
            <div className="relative w-full max-w-md">
              ...
              >
                <RoyalPanel decorativeCorners>
                  <div className="max-h-[min(82dvh,640px)] overflow-y-auto overscroll-contain px-5 py-7 sm:px-8 sm:py-8">
                    <div className="space-y-5 sm:space-y-6">
                      ...
                      <div className="text-center space-y-2.5 sm:space-y-3">
                        <motion.div
                          ...
                          className="relative inline-flex items-center justify-center w-12 h-12 sm:w-14 sm:h-14 rounded-2xl bg-gradient-to-b from-rose/[0.18] to-transparent border border-rose/30 shadow-[0_0_40px_rgba(239,68,68,0.25)]"
                        >
                      ...
                      <div className="pt-0.5">
                        <p className="text-[11px] uppercase tracking-[0.3em] text-gold/70 text-center mb-3 sm:mb-4">
                          Select the Chor
                        </p>
                            ...
                            return (
                              ...
                              >
                                <motion.button
                                  ...
                                  className={`relative w-28 sm:w-36 rounded-2xl border px-2.5 py-3 sm:px-3 sm:py-4 flex flex-col items-center gap-2.5 sm:gap-3 cursor-pointer outline-none transition-colors duration-300 focus-visible:ring-2 focus-visible:ring-gold/70 ${
                                    isSelected
                                ...
                                >
                                  ...
                                  <div
                                    className={`relative w-12 h-12 sm:w-14 sm:h-14 rounded-full flex items-center justify-center text-lg sm:text-xl font-bold text-white border-2 transition-all duration-300 ${
                                      isSelected
                      ...
                      {/* Actions */}
                      <div className="flex flex-col-reverse sm:flex-row gap-2 sm:gap-3 pt-0.5">
                        <motion.button
                          type="button"
                          onClick={onCancel}
                          whileHover={{ scale: 1.02 }}
                          whileTap={{ scale: 0.98 }}
                          className="flex-1 rounded-xl px-4 py-3 sm:px-6 sm:py-3.5 text-sm font-bold text-text-primary border border-gold/30 bg-gradient-to-b from-surface-light to-surface shadow-[0_10px_30px_rgba(0,0,0,0.45)] hover:border-gold/60 hover:text-gold hover:shadow-[0_0_30px_rgba(255,215,0,0.12)] transition-all duration-300 cursor-pointer"
                        >
                          Cancel
                        </motion.button>
                        <motion.button
                          ...
                          className="group flex-1 flex items-center justify-center gap-2.5 rounded-xl px-4 py-3 sm:px-6 sm:py-3.5 text-sm font-black tracking-wide text-black bg-gradient-to-b from-gold-light via-gold to-gold-dark shadow-[0_10px_40px_rgba(255,215,0,0.35)] hover:shadow-[0_16px_50px_rgba(255,215,0,0.55)] disabled:opacity-40 disabled:cursor-not-allowed disabled:shadow-none transition-all duration-300 cursor-pointer"
                        >
